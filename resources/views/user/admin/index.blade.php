                ...
                <div class="card p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0 table-hover">
                            ...
                            @foreach ($combinedProfilesArray as $data)
                                <tr style="background-color: {{ $loop->iteration <= 1 ? '#f6f9fc' : 'transparent' }}">
                                    ...
                                    <td>
                                        <span class="text-secondary text-sm opacity-7">
                                            @if (isset($data['code']))
                                                {{ $data['code'] }}
                                            @elseif (isset($data['student_code']))
                                                {{ $data['student_code'] }}
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <form action="{{ route('admin.create') }}" method="HEAD">
                                                @csrf
                                                @if (isset($data['code']))
                                                ...
                                                @elseif (isset($data['username']))
                                                    <input type="hidden" name="code" value="{{ $data['username'] }}">
                                                @endif
                                                <button class="btn btn-icon btn-3 btn-xs btn-primary btn-xs my-auto"
                                                    ...
                                                    <span class="btn-inner--text">การจัดการ</span>
                                                </button>
                                            </form>
                                            {{-- @include('room.edit')
                                            @include('room.delete') --}}
