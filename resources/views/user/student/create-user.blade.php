...
<style>
    ...
    color: #ffffff; /* Text color for active page link */
    border: none;
}
.card{
    height: 85vh;
...
<p class="mt-3">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <g clip-path="url(#clip0_267_1642)">
          <path d="M9.69997 18.3C10.09 17.91 10.09 17.28 9.69997 16.89L5.82997 13H21C21.55 13 22 12.55 22 12C22 11.45 21.55 11 21 11H5.82997L9.70997 7.12001C10.1 6.73001 10.1 6.10001 9.70997 5.71001C9.31997 5.32001 8.68997 5.32001 8.29997 5.71001L2.69997 11.3C2.30997 11.69 2.30997 12.32 2.69997 12.71L8.28997 18.3C8.67997 18.68 9.31997 18.68 9.69997 18.3Z" fill="#003569"/>
        </g>
        <defs>
                 ...
                 <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-6 text-center">
                        <button class="btn text-light w-100 btn-xs" type="button" style="background-image: linear-gradient(310deg, #6882A8 0%, #003569 100%);">อัปโหลดรูปโปรไฟล์</button>
        ...
        <div class="row">
            ...
            <div class="col-5">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="ชื่อจริง (ภาษาไทย)">
                  </div>
            </div>
            <div class="col-5">
                <div class="form-group">
                    <label for="exampleFormControlInput1">นามสกุล (ภาษาไทย)</label>
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="นามสกุล (ภาษาไทย)">
                  </div>
            </div>
            <div class="col-2">
            ...
            <div class="col-5">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="ชื่อจริง (ภาษาอังกฤษ)">
                  </div>
            </div>
            <div class="col-5">
                <div class="form-group">
                    <label for="exampleFormControlInput1">นามสกุล (ภาษาอังกฤษ)</label>
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="นามสกุล (ภาษาอังกฤษ)">
                  </div>
            </div>
            <div class="col-2">
                <div class="form-group">
                    <label for="exampleFormControlInput1">ชั้นปี</label>
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="ชั้นปี">
                  </div>
            </div>
            <div class="col-5">
                <div class="form-group">
                    <label for="exampleFormControlInput1">คณะ</label>
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="คณะ">
                  </div>
            </div>
            <div class="col-5">
                <div class="form-group">
                    <label for="exampleFormControlInput1">สาขา</label>
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="สาขา">
                  </div>
            </div>
            <div class="col-4">
                <div class="form-group">
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="เบอร์โทรศัพท์">
                  </div>
            </div>
            <div class="col-4">
                <div class="form-group">
                    <label for="exampleFormControlInput1">วันเกิด</label>
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="วันเกิด">
                  </div>
            </div>
...
<a href="{{route('student.index')}}">
                ...
                <button class="btn text-light" type="button" style="background-image: linear-gradient(310deg, #6882A8 0%, #003569 100%);">บันทึก</button>
