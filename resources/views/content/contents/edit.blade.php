...
<div class="modal fade" id="EditSubject{{ $data->content_id }}" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false"
  ...
  <div class="modal-dialog modal-dialog-centered " role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
            {{-- <form action="{{ route('content.update', $data->content_id) }}" method="POST">
              @method('PUT')
              @csrf              <div class="mb-3 text-start"> --}}
                  <label for="" class="form-label">รหัสวิชา<span style="color: red"> * </span></label>
                  <input type="text" class="form-control form-control-sm" id="" name="code" value="{{$data->code}}" placeholder=""
                      >
              </div>
