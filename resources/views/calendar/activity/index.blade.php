                ...
                <div class="card p-4">
                    <div class="row">
                        ...
                        <div class="col text-end">
                            @include('calendar.activity.create')
                            <button class="btn btn-icon btn-3 btn-xs btn-primary my-auto"
                                ...
                                data-bs-toggle="modal" data-bs-target="#CreateActivity">
                                ...
                                <span class="btn-inner--text">เพิ่มกิจกรรม</span>
                            </button>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center mb-0 table-hover">
                            ...
                            @foreach ($Activity as $data)
                                <tr style="background-color: {{ $loop->iteration <= 1 ? '#f6f9fc' : 'transparent' }}">
                                    ...
                                    <td>
                                        <span class="text-secondary text-sm opacity-7">{{ $data->title }}</span>
                                    </td>
                                    <td>
                                        <span class="text-secondary text-sm opacity-7">{{ $data->type }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <button class="btn btn-icon btn-3 btn-xs btn-primary btn-xs my-auto"
                                                ...
                                                data-bs-target="#EditTimetable{{ $data->id }}">
                                                <span class="btn-inner--icon">
                                            ...
                                            @include('calendar.activity.edit')

                                            @include('calendar.activity.delete')
                                        </div>
