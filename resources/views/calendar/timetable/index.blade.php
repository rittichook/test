                ...
                <div class="card p-4">
                    <div class="row">
                        ...
                        <div class="col text-end">
                            @include('calendar.timetable.create')
                            {{-- <button class="btn btn-icon btn-3 btn-xs btn-primary my-auto"
                                ...
                                data-bs-toggle="modal" data-bs-target="#CreateTimetable">
                                ...
                                <span class="btn-inner--text">เพิ่ม</span>
                            </button> --}}
                        </div>
                    </div>
                                ...
                                <tr style="background-color: {{ $loop->iteration <= 1 ? '#f6f9fc' : 'transparent' }}">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            @include('calendar.timetable.edit')

                                            @include('calendar.timetable.delete')
                                        </div>
