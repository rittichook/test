                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            ...
                            <button class="btn btn-icon btn-3 btn-xs btn-primary my-auto"
                                ...
                                data-bs-toggle="modal" data-bs-target="#CreatePrefix">
                                ...
                                <span class="btn-inner--text">เพิ่มคำนำหน้าชื่อ</span>
                            </button>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center mb-0 table-hover">
                            ...
                            @foreach ($Prefix as $data)
                                <tr style="background-color: {{ $loop->iteration <= 1 ? '#f6f9fc' : 'transparent' }}">
                                    ...
                                    <td>
                                        <span class="text-secondary text-sm opacity-7">{{ $data->name_e }}</span>
                                    </td>
                                    <td>
                                        @if ($data->status == 1)
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <button class="btn btn-icon btn-3 btn-xs btn-primary btn-xs my-auto"
                                                ...
                                                data-bs-target="#EditPrefix{{ $data->id }}">
                                                <span class="btn-inner--icon">
