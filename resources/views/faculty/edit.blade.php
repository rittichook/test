...
<div class="modal fade" id="EditFaculty{{ $data->id }}" tabindex="-1" role="dialog" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('faculty.update', $data->id) }}" method="POST">
                    @method('PUT')
                    @csrf
